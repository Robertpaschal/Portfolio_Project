...
class DocumentCreate(DocumentBase):
    """Creates a document using the variables inherited from documentbase"""
    pass

class Document(DocumentBase):
    """Describes varibales that determines how document would be retrieved from the database"""
    id: int
    owner_id: int
    created_at: datetime
...
class Token(BaseModel):
    """The varaibles associated with the creation of a token are defined here"""
    access_token: str
    token_type: str
